              ...
              <div class="box-body">
              	<div class="col-md-6 col-lg-6 col-sm-6">
              		...
              		<div class="form-group">
              			...
              			<input type="text" class="form-control" id="subtitle" placeholder="Enter subtitle" name="subtitle" value="{{ $post->subtitle }}">
              		</div>
              		<div class="form-group">
              	...
              	<div class="col-md-6 col-lg-6 col-sm-6">
              		<div class="form-group">
              			...
              			<input type="file" id="exampleInputFile" class="" name="image">
              		</div><br>
              		<div class="checkbox">
              			<label>
              ...
              <div class="box">
              	<div class="box-header">
              		...
              		<div class="box-body pad">
              				<textarea id="editor1" name="body" placeholder="Place some text here" style="width: 100%; height: 500px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{ $post->body }}</textarea>
              		</div>
              	</div>
